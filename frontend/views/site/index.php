...
<div class="site-index">
    ...
    <div class="jumbotron">
        <h1><?php echo Yii::t('frontend', 'Welcome to Maykke!') ?></h1>

        <p class="lead"><?php echo Yii::t('frontend', 'You are a few steps away from selling your product to USA.') ?></p>

        <p><a class="btn btn-lg btn-success" href="http://www.yiiframework.com"><?php echo Yii::t('frontend', 'User Sign Up') ?></a></p>
        
        <p><a class="btn btn-lg btn-success" href="http://www.yiiframework.com"><?php echo Yii::t('frontend', 'Company Sign Up') ?></a></p>
    </div>
